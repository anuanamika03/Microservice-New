...
@Entity
@Table(name = "weatherforecastarchive")
public class WeatherForecastArchiveModel extends BaseModel {
	...
	@Column(name = "weather_forecast_archive_id")
	private Integer weatherforecastarchiveId;
	...
	public Integer getWeatherforecastarchiveId() {
		return weatherforecastarchiveId;
	}

	public void setWeatherforecastarchiveId(Integer weatherforecastarchiveId) {
		this.weatherforecastarchiveId = weatherforecastarchiveId;
	}
